...
print(f"Generated {len(figures)} base figures")
```
...
try:
    ...
    if df is not None and len(df) > 0:
        ...
        if salary_col is not None and experience_col is not None:
            ...
            # Calculate quartile-based salary ranges
            ...
            fig.add_trace(go.Bar(
                ...
                textposition='auto',
                hovertemplate='<b>%{x}</b><br>Median Salary: $%{y:,.0f}<br><extra></extra>'
            ))
            ...
            fig.update_layout(
                title={
                    'text': "Experience Level Salary Analysis<br><sub>Based on Data Quartiles</sub>",
                    'x': 0.5,
                    'font': {'size': 20}
                },
            ...
            fig2.add_trace(go.Bar(
                ...
                textposition='auto',
                hovertemplate='<b>%{x}</b><br>Job Count: %{y:,}<br><extra></extra>'
            ))

            fig2.update_layout(
                title={
                    'text': "Job Market Distribution by Experience Level",
                    'x': 0.5,
                    'font': {'size': 20}
                },
                xaxis_title="Experience Level",
...
# Display correlation matrix using the abstraction layer
from src.visualization import SalaryVisualizer
...
try:
    ...
    print(f"Correlation analysis: {str(e)}")
```
