...
try:
    ...
    print(f"✅ Loaded {len(df_real):,} records from processed dataset")
    ...
    print(f"⚠️ Error loading class-based analysis: {e}")
    # Use simple fallback
...
if 'results_table' in locals():
    ...
    print(f"\n📊 Analysis based on {len(df_real):,} real job postings")
    ...
    print("⚠️ Industry analysis table not available - check data loading")
```
...
try:
    ...
    print(f"⚠️ Using fallback experience analysis: {e}")
