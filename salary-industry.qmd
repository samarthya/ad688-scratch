...
try:
    ...
    print(f"Loaded and processed {df.count():,} job postings from sample dataset for industry analysis")
    ...
    try:
        ...
        print(f"Loaded and processed {df.count():,} job postings from raw dataset for industry analysis")
