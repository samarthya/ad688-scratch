...
# Display key salary metrics
print("## Key Salary Metrics")
print(f"- **Median Salary**: ${summary['salary_range']['median']:,.0f}")
print(f"- **Salary Range**: ${summary['salary_range']['min']:,.0f} - ${summary['salary_range']['max']:,.0f}")
...
try:
    ...
    try:
        ...
        print("Experience analysis temporarily unavailable")
```
...
try:
    ...
    if not industry_data.empty:
        ...
        for _, row in industry_data.head(5).iterrows():
            ...
            print(f"- **{industry}**: ${salary:,.0f} median salary ({count:,} jobs)")

except Exception as e:
    print(f"Industry analysis error: {e}")
    print("Industry analysis temporarily unavailable")
```
...
try:
    ...
    if not geo_data.empty:
        ...
        for _, row in geo_data.head(5).iterrows():
            ...
            salary = row.get('Median Salary', 0)
            count = row.get('Job Count', 0)
            print(f"- **{location}**: ${salary:,.0f} median salary ({count:,} jobs)")

except Exception as e:
    print(f"Geographic analysis error: {e}")
    print("Geographic analysis temporarily unavailable")
```
...
try:
    ...
    print("- **Strong correlations** indicate factors that move together")
    print("- **Weak correlations** suggest independent salary factors")
    print("- **Negative correlations** show inverse relationships")
    print("- Use this matrix to understand which factors most impact salary")

except Exception as e:
    print(f"Correlation analysis error: {e}")
    print("Correlation matrix visualization temporarily unavailable")
```
