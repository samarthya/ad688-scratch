...
::: {.content-visisble when-format="docx"}
...
### Comprehensive AI/ML Market Dashboard

```{python}
#| label: ai-ml-dashboard
#| echo: false
#| fig-height: 10

from src.visualization.ai_ml_charts import create_ai_ml_combined_dashboard

# Create comprehensive dashboard
fig_ai_ml_dash = create_ai_ml_combined_dashboard(city_stats)
fig_ai_ml_dash.update_layout(
    height=800,
    margin=dict(l=80, r=80, t=100, b=80),
    plot_bgcolor='white',
    paper_bgcolor='white',
...
display_figure(fig_ai_ml_dash, "ai_ml_location_dashboard")
```
